	...
	<main id="main" class="site-main" role="main">
		<?php if (akina_option('ex_register_open')): ?>
						...
						<?php if (akina_option('login_validate')): ?>
							<div id="verification-slider">
								<div id="slider">
									...
									<span id="label">»</span><span id="labelTip">
										<?php _e("Drag the slider to verify", "sakura") /*拖动滑块验证*/?>
									</span>
								</div>
			...
			<?php } else {
				...
				<div class="ex-register-title">
					<h3>
						<?php _e("Success! Redirecting......", "sakura") /*注册成功！正在跳转...*/?>
					</h3>
				</div>
		...
		<?php else: ?>
			<div class="register-close">
				<p>
					<?php _e("Registration is not open yet.", "sakura") /*暂未开放注册。*/?>
				</p>
			</div>
		<?php endif; ?>
	</main><!-- #main -->
