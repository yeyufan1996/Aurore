...
<div class="post-entry">
  <div class="feature">
	...
	<div class="info-meta">
       <div class="comnum">  
        <span><i class="iconfont icon-mark"></i><?php comments_popup_link('NOTHING', '1 '.__("Comment","aurore")/*条评论*/, '% '.__("Comments","aurore")/*条评论*/); ?></span>
		</div>
		<div class="views"> 
		<span><i class="iconfont icon-attention"></i><?php echo get_post_views(get_the_ID()).' '._n('Hit','Hits',get_post_views(get_the_ID()),'aurore')/*热度*/?></span>
		 </div>   
        </div>		
	</footer><!-- .entry-footer -->
	</div>	
