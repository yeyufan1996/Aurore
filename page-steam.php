...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php the_content(); ?>
		<?php
		$id = "76561198418886928";  // 你的SteamID，可以在这里获取:https://steamsignature.com/
		...
		$steam = new SteamCard($id, $steamAPI, 2);  // PS: 个人信息图片是实时更新的，有三种样式，默认为Profile，1为"Lite Status"，2为"Card"
		?>
