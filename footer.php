	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info" theme-info="Sakura v<?php echo AURORE_VERSION; ?>">
			...
			<div class="img-preload">
					...
					<img src="https://cdn.yeyufan.cn/blog/img/disqus-preloader.svg">
				</div>
				<p style="color: #666666;"><?php echo akina_option('footer_info', ''); ?></p>
			</div>
			<div class="footer-device">
			    老夫已经奔跑了<?php echo get_num_queries(); ?>次，花了宝贵的<?php timer_stop(1); ?>秒
			    <br>本站累计存活了:<span id="run_time" style="color: black;"></span><br><br>
			    <img src="https://res-static.hc-cdn.cn/cloudbu-site/china/zh-cn/wangxue/header/logo.svg" alt="HuaWei Cloud" style="height: 2.1em">
...
setInterval(function () {
    $('#run_time').html(runTime())
			...
			<p style="font-family: 'Ubuntu', sans-serif;">
					...
					Theme Sakura <i class="iconfont icon-sakura rotating" style="color: #ffc0cb;display:inline-block"></i>  by Mashiro 
 & Mod by <a href="https://yeyufan.cn/" target="_blank" style="color: #b9b9b9;;text-decoration: underline dotted rgba(0, 0, 0, .1);">Suran</a></br>
