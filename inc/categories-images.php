...
function z_add_texonomy_field()
{
	...
	echo '<div class="form-field">
		<label for="taxonomy_image">' . __('分类/标签图像', 'aurore') /**/. '</label>
		<input type="text" name="taxonomy_image" id="taxonomy_image" value="" />
		<br/>
		<button class="z_upload_image_button button">' . __('添加图像', 'aurore') /*添加图像*/. '</button>
	</div>' . z_script();
}
...
function z_edit_texonomy_field($taxonomy)
{
	...
	echo '<tr class="form-field">
		<th scope="row" valign="top"><label for="taxonomy_image">' . __('分类/标签图像', 'aurore'). '</label></th>
		...
		<button class="z_upload_image_button button">' . __('添加图像', 'aurore') . '</button>
		<button class="z_remove_image_button button">' . __('删除图像', 'aurore') . '</button>
		</td>
	</tr>' . z_script();
}
...
function z_taxonomy_columns($columns)
{
	...
	$new_columns['thumb'] = __('图像', 'aurore') ;
...
{
	if ($column == 'thumb')
		$columns = '<span><img src="' . z_taxonomy_image_url($id, 'thumbnail', TRUE) . '" alt="' . __('暂无', 'aurore') . '" class="wp-post-image" /></span>';
