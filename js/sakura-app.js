...
function checkDarkModeCookie() {
  var dark = getCookie("dark"),
    ...
    hour = today.getHours();
  if (
    mashiro_option.darkmode &&
    ((!dark && (hour > 21 || hour < 7)) ||
      (dark == "1" && (hour >= 22 || hour <= 6)))
  ) {
    setTimeout(function () {
      $("#dark-bg").click();
    }, 100);
    $("#moblieDarkLight").html(
    ...
    cached.find("li").each(function () {
      ...
      cached.on("click", "#" + tagid, function () {
        ...
        if (tagid == "dark-bg") {
          ...
          setTimeout(function () {
            addComment.I("content").style.backgroundColor =
        ...
        switch (tagid) {
          case "white-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg0) + ")"
            );
            break;
          case "sakura-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg1) + ")"
            );
            break;
          case "gribs-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg2) + ")"
            );
            break;
          case "pixiv-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg3) + ")"
            );
            break;
          case "KAdots-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg4) + ")"
            );
            break;
          case "totem-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg5) + ")"
            );
            break;
          case "bing-bg":
            $("body").css(
              "background-image",
              "url(" + checkskin_bg(mashiro_option.skin_bg6) + ")"
            );
            break;
          // case "dark-bg":
...
function nextBG() {
  $(".centerbg").css(
    "background-image",
    "url(" + mashiro_option.cover_api + "?" + bgn + ")"
  );
  bgn = bgn + 1;
}
...
function tableOfContentScroll(flag) {
  if (document.body.clientWidth <= 1200) {
    ...
    $("div").hasClass("have-toc") == false &&
    $("div").hasClass("has-toc") == false
  ) {
      ...
      var id = 1,
        heading_fix =
          mashiro_option.entry_content_theme == "sakura"
            ? $("article").hasClass("type-post")
              ? $("div").hasClass("pattern-attachment-img")
                ? -75
                : 200
              : 375
...
function add_copyright() {
  document.body.addEventListener("copy", function (e) {
    if (
      ...
      mashiro_option.clipboardCopyright
    ) {
      setClipboardText(e);
    }
    addComment.createButterbar(
...
function getqqinfo() {
  ...
  if (
    ...
    if (mashiro_option.qzone_autocomplete) {
      cached
        .filter("#url")
        .val("https://user.qzone.qq.com/" + getCookie("user_qq"));
    }
  ...
  return (function (c) {
    ...
    function (j, e, a) {
      ...
      function f() {
        ...
        if (
          o.tagName === "TEXTAREA" ||
          (o.tagName === "INPUT" && o.getAttribute("type") === "text")
        ) {
      ...
      $(".js-toggle-search").on("click", function () {
        ...
        if (mashiro_option.live_search) {
          ...
          function search_result(
            ...
            return (
              '<div class="ins-selectable ins-search-item" href="' +
              link +
              ...
              comments +
              "</i>" +
              '</header><p class="ins-search-preview">' +
              text +
              "</p></div>"
            );
          }
          ...
          function query(B, A, z) {
            var x,
              ...
              H = "",
              G =
                '<section class="ins-section"><header class="ins-section-header">',
              D = "</section>",
              E = "</header>",
              C = Cx(B, A.trim());
            for (x = 0; x < Object.keys(C).length; x++) {
              ...
              switch ((v = H.type)) {
                ...
                case "tag":
                  p =
                    p +
                    search_result("", H.link, "tag", H.title, "none", "", "");
                  break;
                case "category":
                  r =
                    r +
...
$(function () {
  ...
  console.log(
    " %c The blog was last updated: 2023/9/19 ",
