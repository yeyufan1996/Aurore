...
function aurore_scripts()
{
    if (akina_option('jsdelivr_cdn_test')) {
        ...
        wp_enqueue_script('js_lib', 'https://fastly.jsdelivr.net/gh/yeyufan1996/Aurore@' . AURORE_VERSION . '/cdn/js/lib.min.js', array(), AURORE_VERSION, true);
    }
    if (akina_option('app_no_jsdelivr_cdn')) {
        ...
        wp_enqueue_style('saukra_css', 'https://fastly.jsdelivr.net/gh/yeyufan1996/Aurore@' . AURORE_VERSION . '/style.min.css', array(), AURORE_VERSION);
        wp_enqueue_script('app', 'https://fastly.jsdelivr.net/gh/yeyufan1996/Aurore@' . AURORE_VERSION . '/js/sakura-app.min.js', array(), AURORE_VERSION, true);
    }
    wp_enqueue_script('github_card', 'https://fastly.jsdelivr.net/github-cards/latest/widget.js', array(), AURORE_VERSION, true);
...
function get_author_class($comment_author_email, $user_id)
{
    ...
    {
        echo '<span class="showGrade0" title="Lv0"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_0.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 6 && $author_count < 10) {
        echo '<span class="showGrade1" title="Lv1"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_1.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 10 && $author_count < 20) {
        echo '<span class="showGrade2" title="Lv2"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_2.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 20 && $author_count < 40) {
        echo '<span class="showGrade3" title="Lv3"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_3.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 40 && $author_count < 80) {
        echo '<span class="showGrade4" title="Lv4"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_4.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 80 && $author_count < 160) {
        echo '<span class="showGrade5" title="Lv5"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_5.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    } else if ($author_count >= 160) {
        echo '<span class="showGrade6" title="Lv6"><img src="https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/level/level_6.svg" style="height: 1.5em; max-height: 1.5em; display: inline-block;"></span>';
    }
...
function custom_html()
{
    if (akina_option('login_bg')) {
        ...
        $loginbg = 'https://fastly.jsdelivr.net/gh/mashirozx/Sakura@3.2.7/images/hd.png';
    }
